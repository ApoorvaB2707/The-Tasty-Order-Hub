...
public class ImageHandlingServiceImpl implements ImageHandlingService {
	...
	/*
	 * public String uploadImagemongo(long id, MultipartFile imageFile) throws
	 * IOException { ImageDocument imageDocument = new ImageDocument();
	 * imageDocument.setCustomerId(id); imageDocument.setImageData(new
	 * Binary(imageFile.getBytes()));
	 * imageDocument.setContentType(imageFile.getContentType());
	 * 
	 * ImageDocument savedImage = imageRepository.save(imageDocument); return
	 * savedImage.getId(); }
	 */
