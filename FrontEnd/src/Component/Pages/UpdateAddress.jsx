...
function UpdateAddress() {
  ...
  useEffect(() => {
    ...
    if (ven != null) {
      setUserRole("ven");
      axios
        .get(`${IP_ADDRS}/vendors/${ven.id}/addresses`, {
      ...
      if (cust != null) {
        setUserRole("cust");
        axios
          .get(`${IP_ADDRS}/customers/${cust.id}/addressall`, {
  ...
  const submitData = (e) => {
    ...
    if (userRole == "ven") {
      axios
        .put(`${IP_ADDRS}/vendors/${data.id}/editaddress`, data, {
      ...
      axios
        .put(`${IP_ADDRS}/customers/${data.id}/editaddresses`, data, {
          headers: { Authorization: `Bearer ${data.jwt}` },
        })
        .then((res) => {
          swal(`${res.data}`, "", "success");
